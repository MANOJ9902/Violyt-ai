...
export const API = {
  ...
  BRANDS: {
    ...
    USAGE: { method: "GET", url: (brandId: string) => `/api/v1/brands/${brandId}/usage` } as ApiEndpoint<void, BrandUsageResponse>,
    HISTORY: { method: "GET", url: (brandId: string) => `/api/v1/brands/${brandId}/history` } as ApiEndpoint<void, BrandSpaceHistoryResponse[]>,
    TEMPLATE_DOWNLOAD: { method: "GET", url: (brandId: string) => `/api/v1/brands/${brandId}/template/download` } as ApiEndpoint<void, Blob>,
    TEMPLATE_UPLOAD: { method: "POST", url: (brandId: string) => `/api/v1/brands/${brandId}/template/upload` } as ApiEndpoint<FormData, import("./contracts").BrandTemplateImportResponse>,
    UPDATE: { method: "PUT", url: (brandId: string) => `/api/v1/brands/${brandId}` } as ApiEndpoint<unknown, BrandResponse>,
    UPSERT_SECTIONS: { method: "PUT", url: (brandId: string) => `/api/v1/brands/${brandId}/sections` } as ApiEndpoint<unknown, BrandResponse>,
  ...
  CONTENT: {
    ...
    IMAGE_EDIT_STATE: { method: "POST", url: "/api/v1/content/image-edits/state" } as ApiEndpoint<ImageEditStateRequest, ImageEditStateResponse>,
    IMAGE_EDIT_APPLY: { method: "POST", url: "/api/v1/content/image-edits/apply" } as ApiEndpoint<ImageEditApplyRequest, ImageEditStateResponse>,
  },
  CHAT: {
    ENHANCE_PROMPT: { method: "POST", url: "/api/v1/chat/enhance-prompt" } as ApiEndpoint<ChatEnhancePromptRequest, ChatEnhancePromptResponse>,
    ...
    UPDATE_SESSION: { method: "PATCH", url: (sessionId: string) => `/api/v1/chat/sessions/${sessionId}` } as ApiEndpoint<ChatSessionUpdateRequest, ChatSessionResponse>,
    DELETE_SESSION: { method: "DELETE", url: (sessionId: string) => `/api/v1/chat/sessions/${sessionId}` } as ApiEndpoint<void, { message?: string }>,
